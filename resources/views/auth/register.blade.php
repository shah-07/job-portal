                        ...
                        <form method="POST" action="{{ route('register') }}" class="p-4 border rounded">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="text-black" for="name" :value="__('Name')">Name</label>
                            ...
                            <div class="row form-group mb-4">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="text-black" for="password_confirmation"
                                        :value="__('Confirm Password')">Re-Type Password</label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" value="Sign Up"
                                        class="btn px-4 btn-primary text-white">{{ __('Register') }}</button>
                                </div>
                            </div>
